    ...
    <div class="subscribe">
        ...
        <div class="wrapper">
          <div class="input-wrapper">
            <input id = "input-validation" value = "<?php echo htmlspecialchars($_POST['email-input'] ?? '')?>" name = "email-input" type="text" placeholder="Type your email address here ..." required/>
          </div>
